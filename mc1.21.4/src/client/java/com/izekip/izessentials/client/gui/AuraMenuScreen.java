...
public class AuraMenuScreen extends Screen {
	...
	private static final ResourceLocation CUSTOM_FONT = ResourceLocation.fromNamespaceAndPath("izekip", "inter");
	private static final ResourceLocation GITHUB_ICON = ResourceLocation.fromNamespaceAndPath("izekip", "textures/gui/github_icon.png");
	private static final Style FONT_STYLE = Style.EMPTY.withFont(CUSTOM_FONT);
